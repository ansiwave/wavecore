...
when isMainModule:
  ...
  var p1 = entities.Post(public_key: sysop.public_key.base64, content: entities.initContent(sysopKeys, asciiArt))
  p1.content.sig.base64 = "root" # FIXME: this is just temporary
  ...
  let p2 = entities.Post(parent: p1.content.sig.base64, public_key: bob.public_key.base64, content: entities.initContent(bobKeys, "Hello, world...this is a lame comment\n\n" & loremIpsum))
  server.insertPost(s, p2)
  let p3 = entities.Post(parent: p1.content.sig.base64, public_key: bob.public_key.base64, content: entities.initContent(bobKeys, jabba))
  server.insertPost(s, p3)
  let p4 = entities.Post(parent: p3.content.sig.base64, public_key: alice.public_key.base64, content: entities.initContent(aliceKeys, "That ansi is\n" & fabulous))
  server.insertPost(s, p4)
  let p5 = entities.Post(parent: p3.content.sig.base64, public_key: alice.public_key.base64, content: entities.initContent(aliceKeys, "The people want more"))
  server.insertPost(s, p5)
  let p6 = entities.Post(parent: p1.content.sig.base64, public_key: bob.public_key.base64, content: entities.initContent(bobKeys, hogan))
