...
when isMainModule:
  ...
  server.editPost(s, paths.sysopPublicKey, entities.initContent(common.signWithHeaders(aliceKeys, "Hi i'm alice", alice.public_key, false), alice.public_key), alice.public_key)
  server.editPost(s, paths.sysopPublicKey, entities.initContent(common.signWithHeaders(bobKeys, "Hi i'm bob", bob.public_key, false), bob.public_key), bob.public_key)
