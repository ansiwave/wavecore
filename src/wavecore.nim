...
when isMainModule:
  ...
  var p2 = entities.Post(parent_id: p1.id, parent: p1.content.sig.base58, user_id: bob.id, content: entities.initContent(bobKeys, "Hello, world...this is a lame comment\n\n" & loremIpsum))
  p2.id = server.insertPost(s, p2)
  var p3 = entities.Post(parent_id: p1.id, parent: p1.content.sig.base58, user_id: bob.id, content: entities.initContent(bobKeys, jabba))
  p3.id = server.insertPost(s, p3)
  var p4 = entities.Post(parent_id: p3.id, parent: p3.content.sig.base58, user_id: alice.id, content: entities.initContent(aliceKeys, "That ansi is\n" & fabulous))
  p4.id = server.insertPost(s, p4)
  var p5 = entities.Post(parent_id: p3.id, parent: p3.content.sig.base58, user_id: alice.id, content: entities.initContent(aliceKeys, "The people want more"))
  p5.id = server.insertPost(s, p5)
  var p6 = entities.Post(parent_id: p1.id, parent: p1.content.sig.base58, user_id: bob.id, content: entities.initContent(bobKeys, hogan))
