...
when isMainModule:
  ...
  p1.post_id = server.insertPost(s, p1)
  var
  ...
  alice.user_id = server.insertUser(s, alice)
  bob.user_id = server.insertUser(s, bob)
  var p2 = entities.Post(parent: p1.content.sig.base58, user_id: bob.user_id, content: entities.initContent(bobKeys, "Hello, world...this is a lame comment\n\n" & loremIpsum))
  p2.post_id = server.insertPost(s, p2)
  var p3 = entities.Post(parent: p1.content.sig.base58, user_id: bob.user_id, content: entities.initContent(bobKeys, jabba))
  p3.post_id = server.insertPost(s, p3)
  var p4 = entities.Post(parent: p3.content.sig.base58, user_id: alice.user_id, content: entities.initContent(aliceKeys, "That ansi is\n" & fabulous))
  p4.post_id = server.insertPost(s, p4)
  var p5 = entities.Post(parent: p3.content.sig.base58, user_id: alice.user_id, content: entities.initContent(aliceKeys, "The people want more"))
  p5.post_id = server.insertPost(s, p5)
  var p6 = entities.Post(parent: p1.content.sig.base58, user_id: bob.user_id, content: entities.initContent(bobKeys, hogan))
  p6.post_id = server.insertPost(s, p6)
