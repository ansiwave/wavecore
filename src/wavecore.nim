...
when isMainModule:
  ...
  server.editPost(s, paths.sysopPublicKey, entities.initContent(common.signWithHeaders(sysopKeys, asciiArt, "", false), ""), sysop.public_key)
  ...
  server.editPost(s, paths.sysopPublicKey, entities.initContent(common.signWithHeaders(aliceKeys, "Hi i'm alice", "", false), ""), alice.public_key)
  server.editPost(s, paths.sysopPublicKey, entities.initContent(common.signWithHeaders(bobKeys, "Hi i'm bob", "", false), ""), bob.public_key)
