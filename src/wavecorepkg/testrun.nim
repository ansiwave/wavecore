...
proc main*(s: server.Server) =
  ...
  server.editPost(s, sysopPublicKey, entities.initContent(common.signWithHeaders(sysopKeys, asciiArt, sysop.public_key, common.Edit, sysopPublicKey), sysop.public_key), sysop.public_key)
  let
