...
proc main*(s: server.Server) =
  ...
  os.createDir(paths.staticFileDir / paths.boardsDir / paths.sysopPublicKey / paths.gitDir / paths.ansiwavesDir)
  os.createDir(paths.staticFileDir / paths.boardsDir / paths.sysopPublicKey / paths.gitDir / paths.dbDir)
  db.withOpen(conn, paths.staticFileDir / paths.db(paths.sysopPublicKey), false):
    db.init(conn)
