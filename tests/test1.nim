...
test "query posts":
  ...
  var p2 = Post(parent_id: p1.id, parent_content_sig: p1.content.sig.base58, user_id: bob.id, content: entities.initContent(bobKeys, "Hello, i'm bob"))
  p2.id = entities.insertPost(conn, p2)
  var p3 = Post(parent_id: p2.id, parent_content_sig: p2.content.sig.base58, user_id: alice.id, content: entities.initContent(aliceKeys, "What's up"))
  p3.id = entities.insertPost(conn, p3)
  var p4 = Post(parent_id: p2.id, parent_content_sig: p2.content.sig.base58, user_id: alice.id, content: entities.initContent(aliceKeys, "How are you?"))
