...
All new users besides the sysop will start off hidden. You can find these users by searching for "modhide" and selecting "tags" underneath. These users can post freely, but they won't appear in the subboards yet. You can unhide them by going to their user page and hitting ctrl y (you must wait for the page to finish loading completely). A small edit field will appear, where you can delete the "modhide" tag and hit enter to complete.
